...
# Reviewer inputs are always explicit and package-relative.  A full run must
# supply --source and pass manifest verification before this default is used.
DEFAULT_SOURCE=(ROOT/'inputs'/'PDB_FILES').resolve()
